...
private func cost(ofLocation location: Fretboard.Location) -> Int {
...
private func cost<C: Collection>(of dots: C) -> Int where C.Element == Fretboard.Location {
...
private func findDots<C: Collection>(remainingNotes: C, usedStrings: [Int] = [], on fretboard: Fretboard) -> [Fretboard.Location]? where C.Element == Note {
...
private func extend<C: Collection, D: Collection>(dots: C, notes: D, on fretboard: Fretboard, fretThreshold: Int = 5) -> [Fretboard.Location] where C.Element == Fretboard.Location, D.Element == Note {
