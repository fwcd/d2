...
public class D2Delegate: MessageDelegate {
	...
	public init(withPrefix commandPrefix: String, initialPresence: String? = nil) throws {
		...
		registry["karma", aka: ["upvotes"]] = ReactionLeaderboardCommand(title: "Upvote Karma", name: "upvote", emojiName: "upvote", messageDB: messageDB)
		registry["drinks"] = ReactionLeaderboardCommand(title: "Drinks", name: "drink", emojiName: "🍹", messageDB: messageDB)
