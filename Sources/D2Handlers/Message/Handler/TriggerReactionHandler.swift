...
nonisolated(unsafe) private let goodMorningOrEveningPattern = #/\b[gm](?:u+te+n?|oo+d+)\s+(?:[gm]o+(?:rni+ng|(?:rg(?:e+|ä+h*)|i+)n)|e+ve+ni+ng|a+be+nd|da+y|ta+g|n(?:a+ch|i+gh)t)\b/#.ignoresCase()
