...
RUN [[ -f /usr/lib/python2.7/site-packages ]] && mv /usr/lib/python2.7/site-packages /usr/lib/python2.7/dist-packages && ln -s dist-packages /usr/lib/python2.7/site-packages
