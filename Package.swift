...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "SwiftDiscord", url: "https://github.com/fwcd/swift-discord.git", .revision("a275848d1e341b3427736347a216062245805663")),
        ...
        .package(url: "https://github.com/fwcd/swift-utils.git", from: "1.3.5"),
