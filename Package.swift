...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/nuclearace/SwiftDiscord.git", .revision("48b68b470da3a14a19fd737be1dbf5613eb65a23")), // Using the version introduced in https://github.com/nuclearace/SwiftDiscord/pull/79
