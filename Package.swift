...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/fjfdeztoro/Swift-QR-Code-generator.git", from: "0.0.9")
    ],
    targets: [
        ...
        .target(
            name: "D2",
            dependencies: ["SwiftDiscord", "Commander", "D2Utils", "D2Permissions", "D2Commands"]
        ),
        .target(
            name: "D2Commands",
        ...
        .target(
            name: "D2Utils",
            dependencies: ["SwiftDiscord", "Socket", "Logging"]
        ),
        .testTarget(
            name: "D2CommandTests",
