...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/fwcd/swift-utils.git", from: "1.3.10"),
        ...
        .package(name: "SwiftPlot", url: "https://github.com/KarthikRIyer/swiftplot.git", .revision("a2f79f456a1e265599272ba58f3d1731974f3e3c")),
