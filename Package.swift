...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "SwiftDiscord", url: "https://github.com/fwcd/swift-discord.git", .revision("8be6ac8cfb7e1865d005b473d7fd943da3a5ac19")),
        ...
        .package(url: "https://github.com/fwcd/swift-utils.git", from: "1.3.8"),
