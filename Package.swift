...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/fwcd/swift-discord.git", .upToNextMinor(from: "11.3.0")),
        ...
        .package(url: "https://github.com/swift-calendar/icalendarkit.git", revision: "389fceafc1132ef284c6215118421bc88f1bfc8c"),
